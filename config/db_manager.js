...
const TableKeys = {
    [symbols.TABLE_ADMIN]:['user_name','new_password', 'password','mobile_number','remember_token','otp'],
    ...
    [symbols.TABLE_EMPLOYEES]:['country_code','mobile_number','alternate_mobile_number','email_id','first_name',
            ...
            'employee_job_type_id','employee_slot_id','metadata','remember_token','otp'],
